...
class ResourceGroup(object):
    ...
    def __init__(self, coins=0, workers=0, priests=0, power=0):
        self._coins = coins
    ...
    def __repr__(self):
        return f"{self._coins}, {self._workers}, {self._priests}, {self._power}"

class ResourceRequirements(ResourceGroup):

    def __init__(self, coins=0, workers=0, priests=0, power=0):
        super().__init__(coins, workers, priests, power)